<template>
  <div class="h-full flex flex-col">
    ...
    <div class="flex flex-col gap-10px py-15px relative">
      <div
        v-if="currencyAmount[selectedCurrency]"
        class="value-wrapper"
      >
        <div class="label">
          {{ $t('amount') }}
      ...
      <div class="value-wrapper">
        ...
        <div class="value">
          <span v-if="selectedPayerAddress?.address">
            {{
              `${
                selectedPayerAddress?.address.slice(0, 7)}
                ...${selectedPayerAddress?.address.slice(-7)
                }`
            }}
          </span>
        ...
        <ui-copy-to-clipboard
          class="copy-icon"
          size="22"
          :text-to-copy="selectedPayerAddress?.address
...
export default defineComponent({
  ...
  computed: {
    ...
    qrCodeImg(): string {
      return this.selectedPayerAddress?.address
        ? `${this.selectedPayerAddress.currency}.svg`
        : 'help-circle.svg';
    },
  },
