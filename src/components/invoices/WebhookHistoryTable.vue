  ...
  <div class="card">
    ...
    >
      <table class="w-full">
        ...
        <tbody>
          <template v-for="(item, i) in invoiceDetailsWebhookHistory" :key="i">
            <tr class="border-b border-gray-200">
...
export default defineComponent({
  ...
  computed: {
    ...mapGetters('invoices', {
      invoiceDetailsWebhookHistory: 'getInvoiceDetailsWebhookHistory',
    }),
  },

  watch: {
    invoiceDetailsWebhookHistory() {
      this.requestsArray = Array(this.invoiceDetailsWebhookHistory.length).fill(false);
      this.responseArray = Array(this.invoiceDetailsWebhookHistory.length).fill(false);
    },
  },
